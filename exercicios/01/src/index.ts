...
function addCrewMember(member: string, spaceship: { name: string, crewLimit: number, crews: string[] }) {
...
function sendInMission(spaceship: { name: string, crewLimit: number, crews: string[], inMission: boolean }) {
